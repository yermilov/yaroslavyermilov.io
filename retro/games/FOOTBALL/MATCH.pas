...
{ РЕМОНТ: ФУТБОЛ ПОВІЛЬНІШИЙ ЗА РЕШТУ — власний пін, не глобальна ручка.
  ...
  склади 1500, дрібні паузи 1000 і 2000 — тож навіть при 0.144 вони дають
  108..288 мс і всі до одного лягають НА ПІДЛОГУ. Отже темп футболу — це рівно
  MinDelayMs, і +50% це 480 -> 720 мс. DelayScale множимо на ті самі 1.5 для
  повноти піна: за теперішніх викликів він інертний (2000*0.144 = 288 < 720), але
  ...
  висить рядок», а не «як рідко перемальовується поле». Підняти його втретє
