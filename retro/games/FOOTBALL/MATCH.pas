...
begin
{ РЕМОНТ: ФУТБОЛ ПОВІЛЬНІШИЙ ЗА РЕШТУ НА 50% — власний пін, не глобальна ручка.
  ...
  склади 1500, дрібні паузи 1000 і 2000 — тож при 0.064 вони дають 48..128 мс і
  всі до одного лягають НА ПІДЛОГУ. Отже темп футболу — це рівно MinDelayMs, і
  +50% це 320 -> 480 мс. DelayScale множимо на ті самі 1.5 для повноти піна: за
  теперішніх викликів він інертний (2000*0.096 = 192 < 480), але якщо колись
  з'явиться довга пауза, вона поїде разом з рештою, а не лишиться на старому.
