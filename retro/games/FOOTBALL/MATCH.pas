...
{ РЕМОНТ: ФУТБОЛ ПОВІЛЬНІШИЙ ЗА РЕШТУ — власний пін, не глобальна ручка.
  ...
  Глобальні crt.MinDelayMs / crt.DelayScale обслуговують інші бандли (на
  13.08.2026 — 213/0.042667 для обох CARS і обох QUIDDITCH), і крутити їх заради
  однієї гри не можна — тим паче що для кадрових ігор сповільнення нижче ~3 к/с
  ламає гру. Тому та сама механіка, що в WARWORK: у crt це
