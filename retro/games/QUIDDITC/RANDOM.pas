{ RANDOM (2008) — квідичний матч-симулятор (повністю автоматичний матч).
  Original: /Users/yarik/games/QUIDDITC/RANDOM.PAS.
...
begin
     ...
     repeat
           ...
           g1:=n-random(g-h1)+random(g-h1);
           g2:=n-random(g-h2)+random(g-h2);
           if (abs(n-g1)<=h1) then
              begin
                   ClrScr;
                   if (t-t0) mod 60<10 then Writeln((t-t0) div 60,':0',(t-t0) mod 60)
