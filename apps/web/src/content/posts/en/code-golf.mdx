...
<figure>
  <img src="/blog/code-golf/en/effort.png" alt="Chart: the shortest program seven models wrote across four effort levels, one-shot. haiku stays between 388 and 411, sonnet at high gives 245, fable at low - 305." width="1500" height="900" loading="lazy" decoding="async" />
</figure>
...
<figure>
  <img src="/blog/code-golf/en/research.png" alt="Seven small charts, one per model: the plain prompt against the prompt with research, at each of the four effort levels. An arrow points down wherever research produced a shorter program." width="1500" height="810" loading="lazy" decoding="async" />
</figure>
...
<figure>
  <img src="/blog/code-golf/en/iterate.png" alt="The same seven charts, but the plain prompt against the prompt with iterations, at each of the four effort levels." width="1500" height="810" loading="lazy" decoding="async" />
</figure>
...
<figure>
  <img src="/blog/code-golf/en/loophole.png" alt="Horizontal chart: the shortest program each model ever wrote. fable 25, terra 32, sol 32 and luna 40 sit in a band labelled «found the 2018 loophole», then opus 140, sonnet 169, haiku 277." width="1500" height="810" loading="lazy" decoding="async" />
</figure>
