...
<figure>
  <img src="/blog/court/court.jpg" alt="Screenshot of Claude Code in Remote control: a bare line reading “court” sits under each of two agent messages." width="1080" height="2400" loading="lazy" decoding="async" style={{ display: 'block', width: 'auto', maxWidth: 'min(300px, 100%)', maxHeight: '70vh', margin: '0 auto', borderRadius: '6px' }} />
</figure>
