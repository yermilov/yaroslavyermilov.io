---
title: "Software Engineer in the AI Era"
...
# The Neoversity promo frame from the LinkedIn post — NOT an event photo, despite the filename.
# Kept at the original 01.jpg path ON PURPOSE: Railway's edge serves the prerendered HTML for a
# good while after a deploy, and that cached page points at this exact path — renaming the file
# left the stale page pointing at a 404, i.e. a broken thumbnail on the live site. So new artwork
# is written OVER this path rather than beside it. If real event photos ever land here, give them
# fresh filenames; do not reuse 01.jpg.
